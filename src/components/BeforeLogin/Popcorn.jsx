...
const Popcorn = () => {
  return (
    <div className="flex flex-col relative 500:flex-row 500:items-center 500:gap-2 p-4">
      ...
      <div className="mt-5 p-5 px-2 bg-linear-to-r from-red-900 to-zinc-950 flex flex-col gap-2 items-start 500:mt-0 500:flex-row w-full 500:items-center 500:p-2 rounded">
